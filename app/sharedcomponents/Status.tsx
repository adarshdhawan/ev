...
import { Activity, Building2, Car, MapPin, Network, Zap } from "lucide-react";
...
export default function Status() {
  return (
    <div className="overflow-hidden rounded-[28px] bg-gradient-to-r from-[#10a85a] via-[#0b7b43] to-[#0a5a33] shadow-[0_18px_40px_rgba(16,129,80,0.25)]">
