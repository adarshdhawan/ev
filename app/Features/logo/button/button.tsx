...
export function PlanTripButton() {
  return (
    <button
      type="button"
      className=" ml-10 inline-flex items-center justify-center gap-2 rounded-full bg-[#10b981] px-6 py-3 text-base font-semibold text-white whitespace-nowrap transition-all duration-300 hover:bg-[#059669] hover:shadow-lg active:scale-95"
    >
      Plan your trip
