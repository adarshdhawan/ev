...
const HeroHeader = forwardRef<HTMLSpanElement>(function HeroHeader(_, ref) {
  return (
    <>
      <h1 className="hero-copy-item text-4xl font-semibold leading-[1.05] lg:text-5xl lg:text-5xl">
      ...
      <p className="hero-copy-item max-w-lg text-base leading-relaxed text-slate-700 x-lg:text-lg">
